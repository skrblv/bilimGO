...
import { ArrowLeftOnRectangleIcon, PencilIcon, BookOpenIcon, FireIcon, TrophyIcon, ChartBarIcon, UserGroupIcon, UserPlusIcon } from '@heroicons/react/24/solid';
...
const ProfilePage = () => {
    ...
    const streakSubtext = user.streak > 0 ? (isStreakActiveToday ? 'Отличная работа!' : 'Пройдите урок, чтобы продолжить серию') : 'Пройдите первый урок';
        ...
        <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
            ...
            <div className="bg-surface border border-border rounded-lg p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="flex flex-col items-center md:items-start text-center md:text-left">
                    ...
                    {/* --- ВОТ ПРАВИЛЬНАЯ РАБОЧАЯ КНОПКА --- */}
                    <Link to="/profile/edit" className="w-auto mt-4">
            ...
            <div className="w-full mt-8">
                <Tab.Group selectedIndex={selectedIndex} onChange={handleTabChange}>
                    ...
                    <Tab.Panels className="mt-2">
                        <Tab.Panel className="rounded-xl bg-surface border border-border p-6 focus:outline-none">
